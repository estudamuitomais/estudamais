...
assert.ok(html.includes('<span class="brand-mark" aria-hidden="true">🦉</span><strong class="brand-wordmark"><b>estuda</b><em>+</em></strong>'), 'o menu interno deve mostrar o mascote junto da marca Estuda+');
assert.ok(html.includes('<strong><b>estuda</b><em>+</em></strong>'), 'o cabeçalho público deve mostrar o mascote ao lado da palavra Estuda+');
