...
assert.ok(migration.includes("credits = credits - 5") && migration.includes('for update') && migration.includes('to service_role'), 'somente o backend deve poder debitar os cinco créditos');
